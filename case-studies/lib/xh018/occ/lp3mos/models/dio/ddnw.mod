...
* Spec.     : PS_018_03
* Revision  : 2.0.1; 2009-10-16; CE87DDA4
* ----------------------------------------------------------------------
*                        PARAMETERIZED
* ----------------------------------------------------------------------
...
* 
.subckt ddnw a c area=1e-12 peri=4e-6 par1=1 
xocc_m1 a c  ddnw_ahdl tstep_occ=tstep_soac
d1 a c ddnwd1 area=area pj=peri
d2 a c ddnwd2 area=area pj=peri
.model ddnwd1 d level=1
+ n=1.000e+00
...
+ tlev=1.000e+00     bv=8.000e+01 
+ ibv=1.000e-03      tcv=0.000e+00
+ af=1.000e+00       kf=0.000e+00
.model ddnwd2 d level=1
+ n=2.000e+00
+ js=5.000e-07  jsw=4.000e-13
+ cjo='cj_ddnw/2'
+ cjsw='cjsw_ddnw/2'
