...
* Spec.     : PS_018_03
* Revision  : 1.0.2; 2009-09-30; 738DB9A4
* ----------------------------------------------------------------------
*                        PARAMETERIZED
* ----------------------------------------------------------------------
* TERMINALS: A=anode: PWELL2 (3.3V) C=cathode: NDIFF
* VARIABLES: area , peri
...
* NOTE: TNOM = 27 deg C
* 
.subckt dn3 a c area=1e-12 peri=4e-6 par1=1 
xocc_m1 a c  dn3_ahdl tstep_occ=tstep_soac
d1 a c dn3d1 area=area pj=peri
d2 a c dn3d2 area=area pj=peri
.model dn3d1 d level=1
+ n=1.000e+00
+ js=7.000e-07  jsw=1.000e-12
+ cjo='cj_dn3/2'
+ cjsw='cjsw_dn3/2'
+ m=3.500e-01         vj=7.900e-01
+ mjsw=2.400e-01     php=6.900e-01
+ tt=0.000e+00       fc=5.000e-01
+ rs=1.000e-10       trs=0.000e+00
+ tlev=1.000e+00     bv=6.000e+00 
+ ibv=1.000e-03      tcv=0.000e+00
+ af=1.000e+00       kf=0.000e+00
.model dn3d2 d level=1
+ n=2.000e+00
