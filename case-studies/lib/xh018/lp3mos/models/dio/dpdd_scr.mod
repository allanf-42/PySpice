...
* Spec.     : PS_018_03
* Revision  : 1.0.1; 2010-11-25; 73D2EEC4
* ----------------------------------------------------------------------
*                        PARAMETERIZED
* ----------------------------------------------------------------------
...
* 
.subckt dpdd_scr a c area=1e-12 peri=4e-6 par1=1
d1 a c dpdd_scrd1 area=area pj=peri
d2 a c dpdd_scrd2 area=area pj=peri
.model dpdd_scrd1 d level=1
+ n=1.000e+00
