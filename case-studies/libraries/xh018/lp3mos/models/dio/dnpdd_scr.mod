...
* Device    : dnpdd_scr
* Model     : junction diode subckt / hspice.dio.228
* Process   : XH018
* Extracted : XH018 Spec.
* Spec.     : PS_018_03
* Revision  : 1.0.1; 2010-11-25; 63D2EEC4
* ----------------------------------------------------------------------
*                        PARAMETERIZED
* ----------------------------------------------------------------------
...
* NOTE: special model for ESD purpose
* 
.subckt dnpdd_scr a c area=1e-12 peri=4e-6 par1=1
d1 a c dnpdd_scrd1 area=area pj=peri
d2 a c dnpdd_scrd2 area=area pj=peri
.model dnpdd_scrd1 d level=1
+ n=1.000e+00
